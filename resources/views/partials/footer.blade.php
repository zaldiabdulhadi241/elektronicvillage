<footer class="flex flex-col mx-auto bg-primary text-bg3 px-32 pb-8">
    <div class="py-16 flex flex-row items-start">
        <div class="flex flex-col">
            ...
            <div class="flex flex-row gap-x-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M14.353 6.04297C16.124 6.38697 17.508 7.77197 17.853 9.54297" stroke="white"
    ...
    <p class="text-center">&copy; 2023 All rights reserved. ElectronicVillage</p>
</footer>
